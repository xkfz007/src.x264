...
//   TODO
	...
	{24, {TBT, BT, BT, BT, BT, BT, BT, BT, BT, BT, BT, BT,BTB, TB, TB, TB, TB, TB, TB, TB, TB, TB, TB, TB}, 25.0/24.0}
};
...
//        int ret = sscanf( input_opt.timebase, "%"SCNu64"/%"SCNu64, &i_user_timebase_num, &i_user_timebase_den );
         int ret = sscanf( input_opt.timebase, "%I64/%I64u", &i_user_timebase_num, &i_user_timebase_den ); //TODO
...
//    FAIL_IF_ERROR2( ticks_per_frame < 1 && !param->b_vfr_input, "ticks_per_frame invalid: %"PRId64"\n", ticks_per_frame )
    FAIL_IF_ERROR2( ticks_per_frame < 1 && !param->b_vfr_input, "ticks_per_frame invalid: %I64d\n", ticks_per_frame )
        ...
        if( pic.i_pts <= largest_pts )
        {
            if( cli_log_level >= X264_LOG_DEBUG || pts_warning_cnt < MAX_PTS_WARNING )
				 x264_cli_log( "x264", X264_LOG_WARNING, "non-strictly-monotonic pts at frame %d (%I64d <= %I64d)\n",
							i_frame, pic.i_pts, largest_pts ); //TODO
