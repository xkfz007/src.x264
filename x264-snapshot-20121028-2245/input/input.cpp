...
const x264_cli_csp_t x264_cli_csps[] = {
					{"invalid",0,{0},			{0},		   0, 0},
					{ "i420", 3, { 1, .5, .5 }, { 1, .5, .5 }, 2, 2 }, //0X01
					{ "yv12", 3, { 1, .5, .5 }, { 1, .5, .5 }, 2, 2 }, //0X02
					{ "nv12", 2, { 1,  1 },     { 1, .5 },     2, 2 }, //0X03
					{ "i422", 3, { 1, .5, .5 }, { 1,  1,  1 }, 2, 1 }, //0X04
					{ "yv16", 3, { 1, .5, .5 }, { 1,  1,  1 }, 2, 1 }, //0X05
					{ "nv16", 2, { 1,  1 },     { 1,  1 },     2, 1 }, //0X06
					{ "i444", 3, { 1,  1,  1 }, { 1,  1,  1 }, 1, 1 }, //0X07
					{ "yv24", 3, { 1,  1,  1 }, { 1,  1,  1 }, 1, 1 }, //0X08
					{ "bgr",  1, { 3 },         { 1 },         1, 1 }, //0X09
					{ "bgra", 1, { 4 },         { 1 },         1, 1 }, //0X0A 
					{ "rgb",  1, { 3 },         { 1 },         1, 1 }, //0X0B
};
