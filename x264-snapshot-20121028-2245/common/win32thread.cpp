...
int x264_win32_threading_init( void )
{
    ...
    thread_control.cond_init = (void (__stdcall *)(x264_pthread_cond_t *))GetProcAddress( (HMODULE)kernel_dll, "InitializeConditionVariable" );
    if( thread_control.cond_init )
    {
        /* we're on a windows 6.0+ kernel, acquire the rest of the functions */
        thread_control.cond_broadcast = (void (__stdcall *)(x264_pthread_cond_t *))GetProcAddress((HMODULE) kernel_dll, "WakeAllConditionVariable" );
        thread_control.cond_signal = (void (__stdcall *)(x264_pthread_cond_t *))GetProcAddress( (HMODULE)kernel_dll, "WakeConditionVariable" );
