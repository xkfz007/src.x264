                          ...
                          void (*init_func)(void *), void *init_arg )
{
	...
	void * temp;
    CHECKED_MALLOCZERO( temp, sizeof(x264_threadpool_t) );
	pool = (x264_threadpool_t *)temp;
    *p_pool = pool;
    ...
    CHECKED_MALLOC( temp , pool->threads * sizeof(x264_pthread_t) );

    pool->thread_handle = (x264_pthread_t *)temp;
    ...
    for( int i = 0; i < pool->threads; i++ )
    {
	   ...
	   void *temp;
       CHECKED_MALLOC( temp , sizeof(x264_threadpool_job_t) );
	   job = (x264_threadpool_job_t *)temp;
