...
static const UINT8 intra4x4_cbp_to_golomb[48]=
{
...
static const UINT8 mb_type_b_to_golomb[3][9]=
{
    { 4,  8, 12, 10,  6, 14, 16, 18, 20 }, /* D_16x8 */
    { 5,  9, 13, 11,  7, 15, 17, 19, 21 }, /* D_8x16 */
    { 1, -1, -1, -1,  2, -1, -1, -1,  3 }  /* D_16x16 */
};
static const UINT8 sub_mb_type_p_to_golomb[4]=
{
    3, 1, 2, 0
};
static const UINT8 sub_mb_type_b_to_golomb[13]=
{
