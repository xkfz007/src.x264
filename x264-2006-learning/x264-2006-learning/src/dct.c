...
static void dct2x2dc( INT16 d[2][2] )
{
    int tmp[2][2];
...
static void dct4x4dc( INT16 d[4][4] )
{
    INT16 tmp[4][4];
    int s01, s23;
    int d01, d23;
...
static void idct4x4dc( INT16 d[4][4] )
{
    INT16 tmp[4][4];
    int s01, s23;
    int d01, d23;
...
static inline void pixel_sub_wxh( INT16 *diff, int i_size,
                                  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
    int y, x;
    for( y = 0; y < i_size; y++ )
    {
...
static void sub4x4_dct( INT16 dct[4][4], UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
    INT16 d[4][4];
    INT16 tmp[4][4];
    int i;

    pixel_sub_wxh( (INT16*)d, 4, pix1, i_pix1, pix2, i_pix2 );
...
static void sub8x8_dct( INT16 dct[4][4][4], UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
...
static void sub16x16_dct( INT16 dct[16][4][4], UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
...
static void add4x4_idct( UINT8 *p_dst, int i_dst, INT16 dct[4][4] )
{
    INT16 d[4][4];
    INT16 tmp[4][4];
    int x, y;
...
static void add8x8_idct( UINT8 *p_dst, int i_dst, INT16 dct[4][4][4] )
{
...
static void add16x16_idct( UINT8 *p_dst, int i_dst, INT16 dct[16][4][4] )
{
...
static void sub8x8_dct8( INT16 dct[8][8], UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
    int i;
    INT16 tmp[8][8];

    pixel_sub_wxh( (INT16*)tmp, 8, pix1, i_pix1, pix2, i_pix2 );
...
static void sub16x16_dct8( INT16 dct[4][8][8], UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 )
{
...
static void add8x8_idct8( UINT8 *dst, int i_dst, INT16 dct[8][8] )
{
    int i;
...
static void add16x16_idct8( UINT8 *dst, int i_dst, INT16 dct[4][8][8] )
{
