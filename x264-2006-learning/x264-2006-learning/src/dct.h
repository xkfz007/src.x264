...
typedef struct
{
    void (*sub4x4_dct)   ( INT16 dct[4][4],  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 );
    void (*add4x4_idct)  ( UINT8 *p_dst, int i_dst, INT16 dct[4][4] );

    void (*sub8x8_dct)   ( INT16 dct[4][4][4],  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 );
    void (*add8x8_idct)  ( UINT8 *p_dst, int i_dst, INT16 dct[4][4][4] );

    void (*sub16x16_dct)   ( INT16 dct[16][4][4],  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 );
    void (*add16x16_idct)  ( UINT8 *p_dst, int i_dst, INT16 dct[16][4][4] );

    void (*sub8x8_dct8)   ( INT16 dct[8][8],  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 );
    void (*add8x8_idct8)  ( UINT8 *p_dst, int i_dst, INT16 dct[8][8] );

    void (*sub16x16_dct8)   ( INT16 dct[4][8][8],  UINT8 *pix1, int i_pix1, UINT8 *pix2, int i_pix2 );
    void (*add16x16_idct8)  ( UINT8 *p_dst, int i_dst, INT16 dct[4][8][8] );

    void (*dct4x4dc) ( INT16 d[4][4] );
    void (*idct4x4dc)( INT16 d[4][4] );

    void (*dct2x2dc) ( INT16 d[2][2] );
    void (*idct2x2dc)( INT16 d[2][2] );
