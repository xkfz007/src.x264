...
#define X264_LOG_CONT			0
#define X264_LOG_ERROR          1
#define X264_LOG_WARNING        2
#define X264_LOG_INFO           3
#define X264_LOG_DEBUG          4
...
#if 0
    UINT8     cqm_4iy[16];        /* used only if i_cqm_preset == X264_CQM_CUSTOM */
    UINT8     cqm_4ic[16];
    UINT8     cqm_4py[16];
    UINT8     cqm_4pc[16];
    UINT8     cqm_8iy[64];
...
int write_nalu_bsf( hnd_t handle, UINT8 *p_nal, int i_size );
