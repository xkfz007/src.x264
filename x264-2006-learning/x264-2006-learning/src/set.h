...
typedef struct
{
    ...
    int i_cqm_preset;
    const UINT8 *scaling_list[6]; /* could be 8, but we don't allow separate Cb/Cr lists */

} x264_pps_t;
static const UINT8 x264_cqm_flat16[64] =
{
...
static const UINT8 x264_cqm_jvt4i[16] =
{
      6,13,20,28,
     13,20,28,32,
     20,28,32,37,
...
static const UINT8 x264_cqm_jvt4p[16] =
{
    10,14,20,24,
    14,20,24,27,
    20,24,27,30,
...
static const UINT8 x264_cqm_jvt8i[64] =
{
...
static const UINT8 x264_cqm_jvt8p[64] =
{
...
static const UINT8 * const x264_cqm_jvt[6] =
{
